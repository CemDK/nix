...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  ...
  call s:hi('PmenuSbar',       'NONE',      s:dim_teal,    'NONE')
  ...
  call s:hi('Operator',        s:white,     'NONE',    'NONE')
  call s:hi('Label',           s:red,       'NONE',    'NONE')
  call s:hi('Keyword',         s:orange,    'NONE',    'NONE')
  ...
  call s:hi('Special',         s:green,     'NONE',    'NONE')
  call s:hi('SpecialChar',     s:dim_green, 'NONE',    'NONE')
  call s:hi('Delimiter',       s:dim_green, 'NONE',    'NONE')
  call s:hi('SpecialComment',  s:cyan,      'NONE',    'NONE')
  call s:hi('Tag',             s:orange,    'NONE',    'NONE')
  call s:hi('Debug',           s:blue,      'NONE',    'NONE')

  call s:hi('Todo',            s:orange,    'NONE',    'bold,italic')
  ...
  "call s:hi('nixAttributeDefinition',   s:CLEAR,   'NONE',    'NONE') " ;
  "call s:hi('nixAttributeSet',          s:CLEAR,   'NONE',    'NONE') " { }
  call s:hi('nixBuiltin',                s:magenta, 'NONE',    'NONE') " builtins.
  "call s:hi('nixComment',               s:CLEAR,   'NONE',    'NONE') " # comment
  call s:hi('nixExpr',                   s:orange,  'NONE',    'NONE') " 
  "call s:hi('nixFunctionArgument',      s:CLEAR,   'NONE',    'NONE') " {}
